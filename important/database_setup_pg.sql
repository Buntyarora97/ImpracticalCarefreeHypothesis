...
CREATE TABLE categories (id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY, name varchar(255) NOT NULL, slug varchar(255) NOT NULL, description text, image varchar(255) DEFAULT NULL, video varchar(255) DEFAULT NULL, icon_class varchar(100) DEFAULT "fa-leaf", icon_upload varchar(255) DEFAULT NULL, sort_order integer DEFAULT 0, is_active integer DEFAULT 1, show_on_mobile_top_slider integer DEFAULT 1, show_on_mobile_concern integer DEFAULT 1, show_on_desktop_concern integer DEFAULT 1, show_in_top_menu integer DEFAULT 1, created_at timestamp DEFAULT CURRENT_TIMESTAMP, updated_at timestamp DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (id), UNIQUE (slug)) ;

CREATE TABLE products (id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY, category_id integer DEFAULT NULL, name varchar(255) NOT NULL, slug varchar(255) NOT NULL, sku varchar(100) DEFAULT NULL, price decimal(10,2) NOT NULL, mrp decimal(10,2) DEFAULT NULL, offer_price decimal(10,2) DEFAULT 0.00, offer_label varchar(100) DEFAULT NULL, short_description text, long_description text, benefits text, usage_instructions text, testing_info text, image varchar(255) DEFAULT NULL, video varchar(255) DEFAULT NULL, stock_qty integer DEFAULT 100, stock_status varchar(50) DEFAULT "in_stock", rating decimal(3,2) DEFAULT 4.80, reviews_count integer DEFAULT 0, reward_coins integer DEFAULT 0, is_featured integer DEFAULT 1, is_active integer DEFAULT 1, weight_kg decimal(6,2) DEFAULT 0.50, length_cm decimal(6,2) DEFAULT 15.00, width_cm decimal(6,2) DEFAULT 10.00, height_cm decimal(6,2) DEFAULT 8.00, created_at timestamp DEFAULT CURRENT_TIMESTAMP, updated_at timestamp DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (id), UNIQUE (slug), KEY category_id (category_id)) ;

CREATE TABLE hero_slides (id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY, badge varchar(100) DEFAULT NULL, title varchar(255) DEFAULT NULL, subtitle text, price decimal(10,2) DEFAULT NULL, discount varchar(50) DEFAULT NULL, image varchar(255) DEFAULT NULL, media_type varchar(50) DEFAULT "image", media_url varchar(255) DEFAULT NULL, video_url varchar(255) DEFAULT NULL, button_text varchar(100) DEFAULT "SHOP NOW", button_link varchar(255) DEFAULT "products.php", display_order integer DEFAULT 0, is_active integer DEFAULT 1, created_at timestamp DEFAULT CURRENT_TIMESTAMP, updated_at timestamp DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (id)) ;

CREATE TABLE product_media (id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY, product_id integer NOT NULL, media_type varchar(50) DEFAULT "image", media_url varchar(255) NOT NULL, sort_order integer DEFAULT 0, created_at timestamp DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (id)) ;

CREATE TABLE reviews (id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY, product_id integer DEFAULT NULL, user_name varchar(255) DEFAULT NULL, rating integer DEFAULT 5, review_text text, created_at timestamp DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (id)) ;

CREATE TABLE stories (id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY, name varchar(255) DEFAULT NULL, story_text text, rating integer DEFAULT 5, image_path varchar(255) DEFAULT NULL, created_at timestamp DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (id)) ;

CREATE TABLE reels (id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY, product_id integer DEFAULT NULL, video varchar(255) DEFAULT NULL, views integer DEFAULT 0, is_active integer DEFAULT 0, created_at timestamp DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (id)) ;

CREATE TABLE settings (id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY, key varchar(100) NOT NULL, value text, description varchar(255) DEFAULT NULL, PRIMARY KEY (id), UNIQUE (key)) ;
