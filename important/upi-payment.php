...
<div class="container" style="padding: 60px 20px; max-width: 600px; margin: 0 auto;">
    <div style="background: #fff; padding: 40px; border-radius: 15px; box-shadow: 0 4px 20px rgba(0,0,0,0.05); text-align: center;">
        ...
        <div style="background: #f9f9f9; padding: 20px; border-radius: 10px; margin-bottom: 25px;">
            <div style="font-size: 1.2rem; font-weight: 700; color: #333; margin-bottom: 5px;"><?php echo defined('UPI_HOLDER_NAME') ? e(UPI_HOLDER_NAME) : 'Glimlach'; ?></div>
        ...
        <form method="POST">
            ...
            <button type="submit" style="width: 100%; background: #0f766e; color: #fff; padding: 15px; border-radius: 8px; font-weight: 700; border: none; cursor: pointer;">Submit & Confirm Order</button>
        </form>
    </div>
</div>
