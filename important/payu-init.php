...
define('PAYU_SUCCESS_URL', 'https://' . ($_SERVER['HTTP_HOST'] ?? 'glimlach.in') . '/payu-success.php');
define('PAYU_FAILURE_URL', 'https://' . ($_SERVER['HTTP_HOST'] ?? 'glimlach.in') . '/payu-failed.php');
...
<head>
    ...
    <title>Pay ₹<?= $amount ?> - Glimlach</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2 style="color: #0f766e; font-size: 1.5rem; margin-bottom: 20px;">Glimlach Wellness</h2>
