    ...
    <div class="container">
        <div class="track-card" style="max-width: 600px; margin: 0 auto; background: #fff; padding: 40px; border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.05); text-align: center;">
            ...
            <form id="trackForm" style="margin-bottom: 30px;">
                ...
                <button type="submit" style="background: #0f766e; color: #fff; padding: 12px 40px; border-radius: 5px; font-size: 1rem; font-weight: 600; cursor: pointer; border: none; transition: 0.3s;">
                    Track
                </button>
            </form>
        ...
        <div class="featured-products" style="margin-top: 80px;">
            <h2 style="font-family: 'Playfair Display', serif; text-align: center; margin-bottom: 40px; font-size: 2rem; color: #0f766e;">Best Sellers For You</h2>
                ...
                <?php if (!empty($featuredProducts)): ?>
                    ...
                    <div class="product-card" style="background: #fff; border-radius: 12px; overflow: hidden; box-shadow: 0 5px 15px rgba(0,0,0,0.05); transition: 0.3s; position: relative; border: 1px solid #eee;">
                        ...
                        <div class="product-info" style="padding: 15px;">
                            <h3 style="font-size: 1rem; margin-bottom: 10px; height: 40px; overflow: hidden;"><a href="<?php echo productUrl($product); ?>" style="color: #333;"><?php echo htmlspecialchars($product['name']); ?></a></h3>
                            <div class="product-price" style="display: flex; align-items: center; gap: 10px; margin-bottom: 15px;">
                                <span class="current-price" style="font-weight: 700; color: #0f766e; font-size: 1.1rem;">₹<?php echo number_format((float)$product['price'], 2); ?></span>
                            ...
                            <a href="<?php echo productUrl($product); ?>" style="display: block; text-align: center; background: #0f766e; color: #fff; padding: 8px; border-radius: 5px; font-size: 0.9rem; font-weight: 600;">View Product</a>
                        </div>
                    </div>
                    <?php endforeach; ?>
                <?php else: ?>
                    <p style="text-align: center; grid-column: 1/-1;">Check out our <a href="products.php" style="color: #0f766e; font-weight: 600;">latest collection</a> of Wellness premium products.</p>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
document.getElementById('trackForm').addEventListener('submit', function(e) {
    ...
    resultDiv.innerHTML = `
        <div style="background: #f0f7f2; padding: 15px; border-radius: 8px; border-left: 5px solid #0f766e;">
            <h4 style="color: #0f766e; margin-bottom: 5px;">Order Status: Processing</h4>
        ...
        <div style="margin-top: 20px;">
            <div style="display: flex; align-items: center; gap: 15px; margin-bottom: 15px;">
                <div style="width: 12px; height: 12px; background: #0f766e; border-radius: 50%;"></div>
                <div style="flex: 1;">
